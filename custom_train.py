...
from CustomDeep import baselineSNN
from CustomDeep import S1C1Transform
from CustomDeep import train_unsupervise
from CustomDeep import train_rl
from CustomDeep import test
